package com.xaarlox.pw01.task03.ui.theme
...
// Custom color palette instead of default Material3 - kept dynamicColor = false
// so the app always shows our warm palette, not the user's wallpaper-based colors
@Composable
fun EcoGridTheme(
